                ...
                <div className="flex gap-10 p-5">

                    {
                        clothingData.map((clothing,index) => {
                            ...
                            return <div key={index} className="flex flex-col bg-white rounded-lg shadow-md h-[460px] w-[149px] m-6 overflow-hidden sm:w-80">
                                <img src={clothing.cloth_thumbnail.secure_url} alt={`${clothing.clothing}`} className="h-[70vh]" />
