  ...
  try {
    ...
    if (cloth) {
      ...
      if (cloth.clothing == "Suits") {
        ...
        cloth.cloth_thumbnail.secure_url =
          "https://res.cloudinary.com/dluktmyew/image/upload/v1712071460/lms/apgeaospz5qouvt8bl5q.png";
      } else if (cloth.clothing == "Coats") {
        cloth.cloth_thumbnail.public_id = "lms/iwtuj0gdcv1bbbjmgcxi";
        cloth.cloth_thumbnail.secure_url =
          "https://res.cloudinary.com/dluktmyew/image/upload/v1712854426/lms/iwtuj0gdcv1bbbjmgcxi.jpg";
      } else if (cloth.clothing == "Shirts") {
        cloth.cloth_thumbnail.public_id = "lms/hfwzwmcburluwttmlkvx";
        cloth.cloth_thumbnail.secure_url =
          "https://res.cloudinary.com/dluktmyew/image/upload/v1713618012/lms/hfwzwmcburluwttmlkvx.jpg";
      } else if (cloth.clothing == "T-Shirts") {
        cloth.cloth_thumbnail.public_id = "lms/w63dw79r2qipmg5akcb9";
        cloth.cloth_thumbnail.secure_url =
          "https://res.cloudinary.com/dluktmyew/image/upload/v1712855546/lms/w63dw79r2qipmg5akcb9.jpg";
      } else if (cloth.clothing == "Pants") {
        cloth.cloth_thumbnail.public_id = "lms/y3fh8v8zkcq7alzgputz";
        cloth.cloth_thumbnail.secure_url =
          "https://res.cloudinary.com/dluktmyew/image/upload/v1712855907/lms/y3fh8v8zkcq7alzgputz.jpg";
      }
      await cloth.save();
    }
    ...
    if (req.file) {
      try {
        ...
        if (result && result.public_id && result.secure_url) {
          ...
          cloth.clothing_category[
            cloth.clothing_category.length - 1
          ].thumbnail = {
          ...
          console.error(
            "Cloudinary upload failed or response is incomplete:",
            result
          );
        }
      } catch (error) {
